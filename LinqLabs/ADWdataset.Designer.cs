...
SELECT ProductPhotoID, ThumbNailPhoto, ThumbnailPhotoFileName, LargePhoto, LargePhotoFileName, ModifiedDate FROM Production.ProductPhoto WHERE (ProductPhotoID = @ProductPhotoID)";
        ...
        public virtual int FillBygetdate(ADWdataset.ProductPhotoDataTable dataTable, System.DateTime date1, System.DateTime date2) {
        ...
        public virtual ADWdataset.ProductPhotoDataTable GetDataBy(System.DateTime date1, System.DateTime date2) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(date1));
            this.Adapter.SelectCommand.Parameters[1].Value = ((System.DateTime)(date2));
            ADWdataset.ProductPhotoDataTable dataTable = new ADWdataset.ProductPhotoDataTable();
